    ...
    <div class="flex flex-col md:flex-row min-h-screen w-full">
            ...
            <div class="bg-green-600 h-0 md:min-h-screen relative">
                <div class="p-4 md:p-7 flex justify-end">
                    <div class="flex items-center justify-center">
                        <a href="{{ route('login') }}" class="relative inline-flex items-center justify-center px-6 md:px-10 py-2 md:py-3 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-green-500 md:border-white rounded-lg shadow-md group">
                            <span class="absolute inset-0 flex items-center justify-center w-full h-full text-white duration-300 translate-x-full bg-white group-hover:translate-x-0 ease">
                                <svg class="w-6 h-6 text-green-500 dark:text-green-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h14M5 12l4-4m-4 4 4 4"/>
                                </svg>
                            </span>
                            <span class="absolute flex items-center justify-center w-full h-full text-green-500 md:text-white transition-all duration-300 transform group-hover:translate-y-full ease">Back to login</span>
        ...
        <div class="w-full md:w-1/2 h-screen flex flex-col justify-center px-6 md:px-0 py-8 md:pt-10 dark:bg-gray-800">
            <div class="w-full max-w-md mx-auto md:ml-48 md:mr-8 mt-10 md:mt-0">
                ...
                <h1 class="text-4xl font-extrabold text-black dark:text-white">Health<span class="text-green-600">Care</span></h1>
                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    <div>
                        <button type="submit" class="w-full text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center">{{ __('Sign Up') }}</button>
                    </div>
