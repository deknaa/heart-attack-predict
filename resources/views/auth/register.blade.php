    ...
    <div class="flex flex-col min-h-screen lg:flex-row">
        ...
        <div class="relative w-full overflow-hidden lg:w-1/2 bg-gradient-to-br from-red-500 via-red-600 to-red-700">
            ...
            <div class="absolute inset-0">
                ...
                <div class="absolute w-20 h-20 rounded-full top-1/4 right-1/4 bg-white/5 blur-lg animate-pulse animation-delay-3000"></div>
            </div>
            ...
            <div class="flex flex-col items-center justify-center h-64 lg:h-[calc(100vh-120px)] px-8 text-center relative z-10">
                <div class="max-w-md">
                    ...
                    <p class="mb-6 text-lg leading-relaxed text-white/80">
                        Start your health journey with us. Create your account and get access to personalized healthcare services.
                    </p>
                    
                    <!-- Feature Pills -->
                    <div class="flex flex-wrap justify-center gap-2">
                        <span class="px-3 py-1 text-xs font-medium text-white rounded-full bg-white/20 backdrop-blur-sm">
                            🔒 Secure & Private
                        </span>
                        <span class="px-3 py-1 text-xs font-medium text-white rounded-full bg-white/20 backdrop-blur-sm">
                            👩‍⚕️ Expert Care
                ...
                <div class="absolute hidden bottom-10 right-10 lg:block">
                    <div class="flex items-center justify-center w-20 h-20 rounded-full bg-white/10 backdrop-blur-sm animate-pulse">
            ...
            <div class="relative z-10 w-full max-w-md mx-auto">
                ...
                <div class="p-8 border shadow-xl bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl border-white/20 dark:border-gray-700/30 rounded-2xl">
                    <form action="{{ route('register') }}" method="POST" class="space-y-5">
                        ...
                        <div class="flex items-start p-4 space-x-3 bg-gray-50/50 dark:bg-gray-700/50 rounded-xl backdrop-blur-sm">
                            ...
                            <div class="text-sm">
                                <label for="terms" class="text-gray-700 dark:text-gray-300">
                                    I agree to the 
                                    <button type="button" class="font-semibold text-red-600 underline transition-colors duration-300 hover:text-red-500"
                                        data-modal-target="terms-modal" data-modal-toggle="terms-modal">
                                        Terms & Conditions
                                    </button>
                                    and 
                                    <span class="font-semibold text-red-600 underline transition-colors duration-300 cursor-pointer hover:text-red-500">
                                        Privacy Policy
                                    </span>
                                </label>
                            </div>
                ...
                <div class="mt-8 text-center">
                    <p class="text-gray-600 dark:text-gray-400">
                        ...
                        <a href="{{ route('login') }}" class="font-semibold text-red-600 transition-colors duration-300 hover:text-red-500 hover:underline">
                            Sign in here
                        </a>
                    </p>
                </div>
