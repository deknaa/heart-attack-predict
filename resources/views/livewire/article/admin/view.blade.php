<div class="p-14 sm:ml-64">
    <div class="flex flex-col lg:flex-row lg:items-center justify-between mb-8">
        <div>
            <h1 class="font-bold text-xl">List Article</h1>
            <p class="text-sm">This page for showing list of article</p>
        </div>
        <div class="mt-5 lg:mt-0">
            <a href="/admin/article/create" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2" wire:navigate>
                Create Article
            </a>
        </div>
    </div>
        ...
        <tbody>
            @foreach ($articles as $article)
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer">
                    <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $article->title }}</td>
                    ...
                    <td>
                        ...
                        <a href="#" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900" wire:click.prevent="delete({{ $article->id }})" wire:confirm="Are you sure want to delete this article?">Delete</a>
