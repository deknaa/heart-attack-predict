<div class="p-14 sm:ml-64">
    <h1 class="font-bold text-xl">Edit an Article</h1>
    <p class="text-sm">This page for edit an article</p>
    ...
    <form wire:submit="save">
        <div class="mt-6">
            ...
            <input type="text" id="title" value="{{ $article->title }}"
                ...
                placeholder="Title Article" wire:model.live="title" />
                <div class="text-red-600 font-bold">@error('title') {{ $message }} @enderror</div>
        </div>

        <label for="content" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white mt-6">Content</label>
        <div class="w-full border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            ...
            <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                ...
                <textarea id="content" rows="8"
                    ...
                    placeholder="Write an article..." wire:model.live="content">
                    {{ $article->content }}
                </textarea>
            </div>
        </div>
        <div class="text-red-600 font-bold">@error('content') {{ $message }} @enderror</div>
        <button type="submit"
