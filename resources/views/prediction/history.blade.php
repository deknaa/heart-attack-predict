<x-app-layout>
    <div class="mt-10">
        ...
        <div
            class="fixed rounded-full top-20 left-10 w-72 h-72 bg-gradient-to-r from-blue-400/20 to-purple-400/20 blur-3xl -z-1">
        </div>
        <div
            class="fixed rounded-full bottom-20 right-10 w-96 h-96 bg-gradient-to-r from-pink-400/20 to-orange-400/20 blur-3xl -z-1">
        </div>
        <div
            class="fixed w-64 h-64 transform -translate-x-1/2 -translate-y-1/2 rounded-full top-1/2 left-1/2 bg-gradient-to-r from-green-400/20 to-blue-400/20 blur-3xl -z-1">
        </div>
        ...
        <div class="container relative z-10 px-4 py-8 mx-auto md:py-12 max-w-7xl">
            ...
            <div class="mb-8 md:mb-12">
                <div
                    class="p-6 border shadow-2xl bg-white/40 backdrop-blur-xl rounded-2xl border-white/30 shadow-black/5 md:p-8">
