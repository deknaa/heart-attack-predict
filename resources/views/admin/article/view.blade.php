            ...
            <tbody>
                @foreach ($articles as $article)
                    <tr class="cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-800">
                        ...
                        <td>
                            <a href="{{ route('article.edit', $article->slug) }}" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Edit</a>
                            ...
                            <a href="{{ route('article.show', $article->slug) }}" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Details</button>
                        </td>
                    </tr>
                @endforeach
            </tbody>
