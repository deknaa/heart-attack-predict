                ...
                <div class="flex flex-wrap -mx-4">
                    ...
                    <div class="w-full px-4 lg:w-2/3">
                        ...
                        <div class="flex flex-wrap gap-2 my-8">
                            <a href="#"
                                class="px-3 py-1 text-sm text-gray-700 transition bg-gray-100 rounded-full hover:bg-gray-200">{{ ucwords(str_replace('_', ' ', $article->category)) }}</a>
                        </div>
